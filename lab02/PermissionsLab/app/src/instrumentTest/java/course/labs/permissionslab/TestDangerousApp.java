...
public class TestDangerousApp extends ActivityInstrumentationTestCase2<ActivityLoaderActivity> {
  ...
  public void testRun() {
    ...
    assertTrue("course.labs.permissionslab.BookmarksActivity is not found!", solo.waitForActivity(BookmarksActivity.class));
    ...
    assertTrue("course.labs.permissionslab.GoToDangerousActivity is not found!", solo.waitForActivity(GoToDangerousActivity.class));
