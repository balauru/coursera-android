...
public class ActivityLoaderActivity extends Activity {
  ...
  private void startExplicitActivation() {
    ...
    Intent startActivityIntent = new Intent(this, ExplicitlyLoadedActivity.class);
    startActivityForResult(startActivityIntent, GET_TEXT_REQUEST_CODE);
  }
  ...
  private void startImplicitActivation() {
    ...
    Uri url = Uri.parse("http://www.omnipasteapp.com");
    Intent chooserIntent = Intent.createChooser(new Intent(Intent.ACTION_VIEW, url), "Choose");
  ...
  protected void onActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    if (requestCode == GET_TEXT_REQUEST_CODE && RESULT_OK == resultCode) {
      mUserTextView.setText(data.getStringExtra(ExplicitlyLoadedActivity.EDIT_TEXT_VALUE));
    }
  }
}
